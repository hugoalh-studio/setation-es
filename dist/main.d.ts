 ...
 * @returns {Generator<T[], void, unknown>} A combinations subset generator.
 */
declare function combination<T>(set: T[] | Set<T>, options?: SetationOptions): Generator<T[], void, unknown>;
/**
 ...
 * @returns {Generator<T[], void, unknown>} A permutations subset generator.
 */
declare function permutation<T>(set: T[] | Set<T>, options?: SetationOptions): Generator<T[], void, unknown>;
export { combination, permutation, type SetationOptions as CombinationOptions, type SetationOptions as PermutationOptions };
